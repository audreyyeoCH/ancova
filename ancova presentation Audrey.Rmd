...
#viagraData
par(mfrow=c(1,2))
boxplot(libido~dose, data= viagraData, outline = FALSE)
beeswarm(libido~dose, data= viagraData, main = "Libido", pch = 16, col = rainbow(8), add = TRUE)
beeswarm(libido~dose, data= viagraData, main = "Libido", pch = 16, col = rainbow(8), add = TRUE)
bxplot(libido~dose, data = viagraData, add = TRUE)

beeswarm(partnerLibido~dose, data= viagraData, pch = 16, col = rainbow(8), main = "Partner Libido" )
bxplot(partnerLibido ~ dose, data = viagraData, add = TRUE)
